...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("aerum");
    case mBTC: return QString("maerum");
    case uBTC: return QString::fromUtf8("μaerum");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("aerum");
    case mBTC: return QString("Milli-aerum (1 / 1,000)");
    case uBTC: return QString("Micro-aerum (1 / 1,000,000)");
    default: return QString("???");
    }
}
