...
const string strMessageMagic = "aerum Signed Message:\n";
...
{
    int64_t nSubsidy = 3 * COIN; // Normal block reward 10 aerum coin
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
   ...
   else if (nHeight == 7) {nSubsidy = 1000000 * COIN;}                                                   // Premine
   else if (nHeight > 7 && nHeight < 1000) {nSubsidy = (10 * COIN;}                                   // IRC Launch
