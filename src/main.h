...
static const int64_t MAX_SINGLE_TX = 21000000 * COIN; // 21 Million aerum coins
/** Moneyrange params */
...
/** Protocol toggle */
inline bool IsProtocolV3(int64_t nTime) { return false; } // POSv3 disabled, aerum uses min and max age
/** Future drift value */
...
inline int64_t MasternodeCollateral(int nHeight) { return 5000; } // 5K aerum required as collateral
